...
public:
	...
	static constexpr int ITEM_POS_X = 250;
	static constexpr int ITEM_POS_Y = 210;
	static constexpr int ITEM_INTERVAL_Y = 50;
	...
	static constexpr std::array<const char*, static_cast<int>(Item::MAX)> ITEM_TEXTS = { "BGM音量", "SE音量", "キーコンフィグ", "タイトルへ" };
